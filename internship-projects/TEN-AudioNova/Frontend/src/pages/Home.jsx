...
// import { useMiniPlayer } from "../context/MiniPlayerContext"; // ✅ Add this
...
//   const [hoveredCard, setHoveredCard] = useState(null);
//   const [playlists, setPlaylists] = useState([]);
//   const { openPlayer } = useMiniPlayer(); // ✅ Use MiniPlayer
...
//       openPlayer(playlist.songs[0], playlist.songs);
//     }
//   };
...
//             subtitle="Share your music"
//             gradient="from-[#4facfe] to-[#00f2fe]"
//             onClick={() => console.log("Upload clicked")} // Update if you handle modal
//           />
//         </div>
...
//             Made for You
//           </h3>
//           <p className="text-white/60 mb-6">Curated playlists based on your taste</p>
//         </div>
  ...
  return (
    <div className="relative flex min-h-screen bg-gradient-to-br from-[#0a0e17] via-[#1a1f2e] to-[#0f1419] text-[#F4F4F5] overflow-hidden">
      ...
      <main className="flex-1 p-4 sm:p-6 md:p-8 z-10 w-full relative">
        ...
        {/* Removed AI Generator & Upload cards here */}
