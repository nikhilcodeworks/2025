...
const Search = () => {
  ...
  // Dummy song data
  const allSongs = [
    { id: 1, title: "Song Title 1", artist: "Artist 1", album: "Album 1", img: "1.jpeg" },
    { id: 2, title: "Song Title 2", artist: "Artist 2", album: "Album 2", img: "2.jpeg" },
    { id: 3, title: "Song Title 3", artist: "Artist 3", album: "Album 3", img: "3.jpeg" },
    { id: 4, title: "Song Title 4", artist: "Artist 4", album: "Album 4", img: "2.jpeg" },
    { id: 5, title: "Song Title 5", artist: "Artist 5", album: "Album 5", img: "1.jpeg" },
  ];
        ...
        <div className="relative mb-6">
          <div className="flex items-center bg-gray-800 rounded-md overflow-hidden px-4">
            ...
            <Input
              ...
              className="flex-grow bg-transparent text-white placeholder-gray-400 border-none focus:ring-0"
            />
            {!searchQuery && <AiOutlineSearch className="ml-2 text-gray-400" size={20} />}
          </div>
        </div>
              ...
              results.map((song) => (
                ...
                >
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div className="flex items-center gap-4">
                      <img
                        src={`/${encodeURIComponent(song.img)}`}
                        alt={song.title}
                        className="w-16 h-16 sm:w-20 sm:h-20 rounded-md object-cover"
                      />
                      <div>
                    ...
                    <div className="flex gap-3 justify-end">
                      <Button variant="link" className="text-blue-400 hover:underline px-0">
                        ▶ Play
                      </Button>
                      <Button variant="ghost" className="text-gray-400 hover:text-red-500 transition">
                        ♥
                      </Button>
                    </div>
                  </div>
